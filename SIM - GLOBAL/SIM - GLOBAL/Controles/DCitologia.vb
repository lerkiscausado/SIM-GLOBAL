...
Namespace Controles
    Public Class DCitologia
        ...
        Public Shared Function Cargar(ByVal filtro As String) As SIM___GLOBAL.Modelo.Citologia 'SIM_CITOPATO.My.Modelo.Citologia
            Try
                ...
                Dim _Citologia = New SIM___GLOBAL.Modelo.Citologia 'SIM_CITOPATO.My.Modelo.Citologia
        ...
        Public Function Existe(ByVal filtro As String) As Boolean
            ...
            Return Nothing
        End Function
        Public Sub Guardar(ByVal _Citologia As SIM___GLOBAL.Modelo.Citologia)
            Try
                Dim query As String
        ...
        Public Shared Function UltimoRegistroCitologia() As DataSet
            ...
            End Try
        End Function
        Public Shared Function OrdenCitologia(ByVal filtro As String) As SIM___GLOBAL.Modelo.Citologia 'SIM_CITOPATO.My.Modelo.Citologia
            Try
        ...
        Public Function GenerarConsecutivo() As Integer
            ...
            Try
                Dim query As String = String.Format("SELECT COUNT(`citologia`.`ID`) AS CONSECUTIVO FROM `citologia` " _
                                                    & "INNER JOIN `ordenes` ON (`citologia`.`ID_ORDEN` = `ordenes`.`ID`) " _
