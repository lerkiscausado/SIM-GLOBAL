    ...
    Public Class DPlantillasInformes
        ...
        Public Shared Function Cargar(ByVal filtro As String) As SIM___GLOBAL.Modelo.PlantillasInformes
            Try
                ...
                _PlantillasInformes.nombrePlantilla = _ds.Tables(0).Rows(0)(3).ToString()
                _PlantillasInformes.Campo1 = _ds.Tables(0).Rows(0)(4).ToString()
                _PlantillasInformes.Campo2 = _ds.Tables(0).Rows(0)(5).ToString()
                _PlantillasInformes.Campo3 = _ds.Tables(0).Rows(0)(6).ToString()
                _PlantillasInformes.Campo4 = _ds.Tables(0).Rows(0)(7).ToString()
                _PlantillasInformes.Campo5 = _ds.Tables(0).Rows(0)(8).ToString()
                _PlantillasInformes.Campo6 = _ds.Tables(0).Rows(0)(9).ToString()
                _PlantillasInformes.Estado = _ds.Tables(0).Rows(0)(10).ToString()
        ...
        Public Sub Guardar(ByVal _PlantillasInformes As SIM___GLOBAL.Modelo.PlantillasInformes)
            Try
                ...
                If Existe(_PlantillasInformes.IdEspecialista, _PlantillasInformes.IdTipoEstudio) = True Then
                    query = "UPDATE plantillas_informes SET nombreplantilla='" & _PlantillasInformes.nombrePlantilla & "', campo1='" & _PlantillasInformes.Campo1 & "', " _
                ...
                Else
                    query = "insert into plantillas_informes values('" & _PlantillasInformes.Id & "', " _
                             & "'" & _PlantillasInformes.IdTipoEstudio & "','" & _PlantillasInformes.IdEspecialista & "', '" & _PlantillasInformes.nombrePlantilla & "' " _
        ...
        Public Sub GuardarPlantilla(ByVal _PlantillasInformes As SIM___GLOBAL.Modelo.PlantillasInformes)
            Try
                Dim query As String
                If ExistePlantilla(_PlantillasInformes.Id) = True Then
                    query = "UPDATE plantillas_informes SET nombreplantilla='" & _PlantillasInformes.nombrePlantilla & "', campo1='" & _PlantillasInformes.Campo1 & "', " _
                           & "campo2='" & _PlantillasInformes.Campo2 & "',campo3='" & _PlantillasInformes.Campo3 & "', " _
                           & "campo4='" & _PlantillasInformes.Campo4 & "',campo5='" & _PlantillasInformes.Campo5 & "', " _
                           & "campo6='" & _PlantillasInformes.Campo6 & "' where id='" & _PlantillasInformes.Id & "'"
        ...
        Public Function ExistePlantilla(ByVal id As String) As Boolean

            Try
                Dim query As String =
                        String.Format("SELECT id FROM plantillas_informes WHERE id='" & id & "'")
                _conn = ConexionODBC.Open()
                Dim comando = New OdbcCommand(query, _conn)
                Dim reader As OdbcDataReader
                reader = comando.ExecuteReader()
        ...
        Public Function Listar() As DataSet
            Try
                Dim query As String =
                                    String.Format(
                                        "SELECT `plantillas_informes`.`ID`, plantillas_informes.nombreplantilla AS PLANTILLA, `empleados`.`NOMBRE_EMPLEADO` AS `ESPECIALISTA`, " _
