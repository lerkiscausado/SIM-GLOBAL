...
Namespace Controles
    Public Class DFacturas
        ...
        End Function
        Public Function RelacionFacturas() As DataSet
            Try
                Dim query As String =
                    String.Format("SELECT ordenes.ID AS ORDEN, ordenes.CONSECUTIVO AS CASO, " _
                    ...
                    & "sedes.nombre AS ENTIDAD, subentidades.nombre AS SUBENTIDAD, tipo_estudio.NOMBRE_TIPO_ESTUDIO AS ESTUDIO, " _
                    & "ordenes.AUTORIZACION, especimenes.nombre AS ESPECIMEN, GROUP_CONCAT(detalle_orden.codigo_cups) AS CUPS, " _
                    & "SUM(detalle_orden.valor) AS VALOR, ordenes.ESTADO FROM detalle_orden	" _
