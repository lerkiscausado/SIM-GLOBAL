...
Namespace Controles
    Public Class DImagenesTemporales
        ...
        Private Function Imagen_Bytes(ByVal Imagen As Image) As Byte()
            ...
            End If
        End Function
        Public Sub Guardar(ByVal _ImagenesTemporales As SIM___GLOBAL.Modelo.ImagenesTemporales)
            Try
                'Dim query As String
        ...
        End Function
        Public Function ExisteRegistroImagenes(ByVal IdOrden As String) As Boolean

            Try
                Dim query As String =
                    String.Format("SELECT ID FROM imagenes_temporales WHERE id_orden='" & IdOrden & "'")
                _conn = ConexionODBC.Open()
                Dim comando = New OdbcCommand(query, _conn)
            ...
            Return Nothing
        End Function
        Public Sub GuardarImagenesActivas(ByVal _ImagenesTemporales As SIM___GLOBAL.Modelo.ImagenesTemporales)
            Try
                Dim query As String
                query = "INSERT INTO imagenes_temporales VALUES('','" & _ImagenesTemporales.IdOrden & "','" & _ImagenesTemporales.IdDetalleOrden & "', " _
                            & "'" & _ImagenesTemporales.Imagen1 & "','" & _ImagenesTemporales.Imagen2 & "', " _
                            & "'" & _ImagenesTemporales.Imagen3 & "','" & _ImagenesTemporales.Imagen4 & "', " _
                            & "'" & _ImagenesTemporales.Imagen5 & "','" & _ImagenesTemporales.Imagen6 & "', " _
                            & "'" & _ImagenesTemporales.Imagen7 & "','" & _ImagenesTemporales.Imagen8 & "', " _
                            & "'" & _ImagenesTemporales.Imagen9 & "')"
                _conn = ConexionODBC.Open()
                Dim comando = New OdbcCommand(query, _conn)
                comando.ExecuteNonQuery()
                ConexionODBC.Close(_conn)
