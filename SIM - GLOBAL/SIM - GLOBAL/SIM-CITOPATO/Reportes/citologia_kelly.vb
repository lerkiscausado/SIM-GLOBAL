...
Public Class citologia_kelly
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIM_CITOPATO.citologia_kelly.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcitologia_kelly
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As citologia_kelly = New citologia_kelly()
        rpt.Site = Me.Site
        Return rpt
    End Function
