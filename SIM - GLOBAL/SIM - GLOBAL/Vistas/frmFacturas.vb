...
Public Class frmFacturas
        ...
        If _ClickGrillaFacturas <> "" Then
            ...
            For i As Integer = 0 To _ds.Tables(0).Rows.Count - 1
                    ...
                    If tipoEstudio = "P" Then
                        ...
                        ' MsgBox("Tiene pendiente estudios por realizar")
                        'Else
                        'End If
            ...
            'Else
            'MsgBox("Para poder generar los Rips deben realizarse las consultas y/o procedimientos")
            'End If
        Else
            MsgBox("No ha seleccionado la factura")
        End If
    End Sub
    ...
    Private Sub GCConsultar_DoubleClick(sender As Object, e As EventArgs) Handles GCConsultar.DoubleClick
        _ds = New DataSet
        _ds = _DFacturas.ListarDetalle1Factura(_ClickGrillaFacturas)
        GCDetalleFactura.DataSource = _ds.Tables(0)
        xtcFactura.SelectedTabPage = xtpDetalleFactura
    End Sub
    Private Sub GVDetalleFactura_RowUpdated(sender As Object, e As RowObjectEventArgs) Handles GVDetalleFactura.RowUpdated
        If e.RowHandle >= 0 Then
            _DFacturas.ActualizarAutorizacion(GVDetalleFactura.GetRowCellValue(e.RowHandle.ToString, "ORDEN").ToString(), GVDetalleFactura.GetRowCellValue(e.RowHandle.ToString, "AUTORIZACION").ToString())
        End If
    End Sub
End Class