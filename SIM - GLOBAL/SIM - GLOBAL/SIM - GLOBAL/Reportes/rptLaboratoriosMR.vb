...
Public Class rptLaboratoriosMR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIM___GLOBAL.rptLaboratoriosMR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLaboratoriosMR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLaboratoriosMR = New rptLaboratoriosMR()
        rpt.Site = Me.Site
        Return rpt
    End Function
