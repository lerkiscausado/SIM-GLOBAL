...
Public Class rptCodigoBarra
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIM___GLOBAL.rptCodigoBarra.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCodigoBarra
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCodigoBarra = New rptCodigoBarra()
        rpt.Site = Me.Site
        Return rpt
    End Function
