...
Public Class rptReciboCajaOF
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIM___GLOBAL.rptReciboCajaOF.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReciboCajaOF
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReciboCajaOF = New rptReciboCajaOF()
        rpt.Site = Me.Site
        Return rpt
    End Function
