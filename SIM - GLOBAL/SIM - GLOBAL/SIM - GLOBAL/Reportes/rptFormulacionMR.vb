...
Public Class rptFormulacionMR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIM___GLOBAL.rptFormulacionMR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFormulacionMR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFormulacionMR = New rptFormulacionMR()
        rpt.Site = Me.Site
        Return rpt
    End Function
