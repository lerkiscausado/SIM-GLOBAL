...
Public Class rptFacturaDetalle
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIM___GLOBAL.rptFacturaDetalle.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFacturaDetalle
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFacturaDetalle = New rptFacturaDetalle()
        rpt.Site = Me.Site
        Return rpt
    End Function
