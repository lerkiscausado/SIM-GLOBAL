...
Public Class rptFormulacion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIM___GLOBAL.rptFormulacion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFormulacion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFormulacion = New rptFormulacion()
        rpt.Site = Me.Site
        Return rpt
    End Function
