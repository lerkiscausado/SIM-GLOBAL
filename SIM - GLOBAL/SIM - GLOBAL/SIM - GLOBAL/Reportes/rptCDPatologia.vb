...
Public Class rptCDPatologia
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIM___GLOBAL.rptCDPatologia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCDPatologia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCDPatologia = New rptCDPatologia()
        rpt.Site = Me.Site
        Return rpt
    End Function
