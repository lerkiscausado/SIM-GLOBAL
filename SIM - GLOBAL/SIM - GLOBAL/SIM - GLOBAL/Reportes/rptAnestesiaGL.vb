...
Public Class rptAnestesiaGL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIM___GLOBAL.rptAnestesiaGL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAnestesiaGL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAnestesiaGL = New rptAnestesiaGL()
        rpt.Site = Me.Site
        Return rpt
    End Function
