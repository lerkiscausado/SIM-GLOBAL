...
Public Class rptLaboratorios
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIM___GLOBAL.rptLaboratorios.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLaboratorios
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLaboratorios = New rptLaboratorios()
        rpt.Site = Me.Site
        Return rpt
    End Function
