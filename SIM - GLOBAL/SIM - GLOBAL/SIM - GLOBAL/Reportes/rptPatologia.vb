...
Public Class rptPatologia
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIM___GLOBAL.rptPatologia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPatologia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPatologia = New rptPatologia()
        rpt.Site = Me.Site
        Return rpt
    End Function
