...
Public Class rptCitologia_kelly
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIM___GLOBAL.rptCitologia_kelly.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCitologia_kelly
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCitologia_kelly = New rptCitologia_kelly()
        rpt.Site = Me.Site
        Return rpt
    End Function
