...
Public Class rptProcedimientos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIM___GLOBAL.rptProcedimientos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptProcedimientos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptProcedimientos = New rptProcedimientos()
        rpt.Site = Me.Site
        Return rpt
    End Function
