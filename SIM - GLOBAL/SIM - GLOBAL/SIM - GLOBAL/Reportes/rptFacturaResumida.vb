...
Public Class rptFacturaResumida
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIM___GLOBAL.rptFacturaResumida.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFacturaResumida
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFacturaResumida = New rptFacturaResumida()
        rpt.Site = Me.Site
        Return rpt
    End Function
