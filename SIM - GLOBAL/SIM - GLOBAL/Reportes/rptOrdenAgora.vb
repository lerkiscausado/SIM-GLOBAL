...
Public Class rptOrdenAgora
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIM___GLOBAL.rptOrdenAgora.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptOrdenAgora
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptOrdenAgora = New rptOrdenAgora()
        rpt.Site = Me.Site
        Return rpt
    End Function
