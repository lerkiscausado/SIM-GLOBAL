...
Public Class rptHistoriaClinica
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIM___GLOBAL.rptHistoriaClinica.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptHistoriaClinica
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptHistoriaClinica = New rptHistoriaClinica()
        rpt.Site = Me.Site
        Return rpt
    End Function
