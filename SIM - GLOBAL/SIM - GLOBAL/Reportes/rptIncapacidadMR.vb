...
Public Class rptIncapacidadMR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIM___GLOBAL.rptIncapacidadMR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptIncapacidadMR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptIncapacidadMR = New rptIncapacidadMR()
        rpt.Site = Me.Site
        Return rpt
    End Function
