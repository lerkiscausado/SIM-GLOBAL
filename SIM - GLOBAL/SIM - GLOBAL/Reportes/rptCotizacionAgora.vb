...
Public Class rptCotizacionAgora
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIM___GLOBAL.rptCotizacionAgora.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCotizacionAgora
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCotizacionAgora = New rptCotizacionAgora()
        rpt.Site = Me.Site
        Return rpt
    End Function
