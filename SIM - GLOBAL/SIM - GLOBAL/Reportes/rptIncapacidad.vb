...
Public Class rptIncapacidad
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIM___GLOBAL.rptIncapacidad.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptIncapacidad
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptIncapacidad = New rptIncapacidad()
        rpt.Site = Me.Site
        Return rpt
    End Function
