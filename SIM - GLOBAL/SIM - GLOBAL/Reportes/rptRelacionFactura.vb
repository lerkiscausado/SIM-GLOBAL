...
Public Class rptRelacionFactura
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIM___GLOBAL.rptRelacionFactura.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRelacionFactura
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRelacionFactura = New rptRelacionFactura()
        rpt.Site = Me.Site
        Return rpt
    End Function
