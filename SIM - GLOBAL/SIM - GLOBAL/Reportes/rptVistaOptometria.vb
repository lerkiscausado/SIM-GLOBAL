...
Public Class rptVistaOptometria
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIM___GLOBAL.rptVistaOptometria.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptVistaOptometria
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVistaOptometria = New rptVistaOptometria()
        rpt.Site = Me.Site
        Return rpt
    End Function
