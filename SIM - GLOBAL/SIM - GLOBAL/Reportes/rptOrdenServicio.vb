...
Public Class rptOrdenServicio
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIM___GLOBAL.rptOrdenServicio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptOrdenServicio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptOrdenServicio = New rptOrdenServicio()
        rpt.Site = Me.Site
        Return rpt
    End Function
