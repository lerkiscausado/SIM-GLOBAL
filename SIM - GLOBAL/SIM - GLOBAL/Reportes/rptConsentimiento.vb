...
Public Class rptConsentimiento
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIM___GLOBAL.rptConsentimiento.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptConsentimiento
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptConsentimiento = New rptConsentimiento()
        rpt.Site = Me.Site
        Return rpt
    End Function
