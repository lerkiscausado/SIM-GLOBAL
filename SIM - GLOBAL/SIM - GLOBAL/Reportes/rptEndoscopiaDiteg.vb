...
Public Class rptEndoscopiaDiteg
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIM___GLOBAL.rptEndoscopiaDiteg.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEndoscopiaDiteg
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEndoscopiaDiteg = New rptEndoscopiaDiteg()
        rpt.Site = Me.Site
        Return rpt
    End Function
