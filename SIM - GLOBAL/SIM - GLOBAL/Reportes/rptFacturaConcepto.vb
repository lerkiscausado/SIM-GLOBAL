...
Public Class rptFacturaConcepto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIM___GLOBAL.rptFacturaConcepto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFacturaConcepto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFacturaConcepto = New rptFacturaConcepto()
        rpt.Site = Me.Site
        Return rpt
    End Function
