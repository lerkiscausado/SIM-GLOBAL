...
Public Class frmEndoscopia
    ...
    Private Sub CargarEndoscopia()
        ...
        txtCampo1.Text = _Endoscopia.Campo1
    ...
    Private Sub Nuevo()
        ...
        Select Case _ClickTipoEstudio
            Case "COLONOSCOPIA"
                lblReporteEstudio.Text = "Informe de Colonoscopia"
                txtCampo1.Text = "INSPECCIÓN:" & vbCrLf & vbCrLf & "TACTO RECTAL:" & vbCrLf & vbCrLf & "ENDOSCOPIA:" & vbCrLf & vbCrLf & "DIAGNOSTICO ENDOSCOPICO:"
            Case "RECTOSCOPIA"
                lblReporteEstudio.Text = "Informe de Rectoscopia"
                txtCampo1.Text = "INSPECCIÓN:" & vbCrLf & vbCrLf & "TACTO RECTAL:" & vbCrLf & vbCrLf & "ENDOSCOPIA:" & vbCrLf & vbCrLf & "DIAGNOSTICO ENDOSCOPICO:"
            Case "ENDOSCOPIA"
                lblReporteEstudio.Text = "Informe de Endoscopia"
                txtCampo1.Text = "ESOFAGO: " & vbCrLf & vbCrLf & "ESTOMAGO: " & vbCrLf & vbCrLf & "DUODENO:" & vbCrLf & vbCrLf & "DIAGNOSTICO ENDOSCOPICO:"
    ...
    Private Sub GuardarEndoscopia()
        ...
        _Endoscopia.Campo1 = txtCampo1.Text
        _Endoscopia.Campo2 = ""
        _Endoscopia.Campo3 = ""
        _Endoscopia.Campo6 = _NombreCups
        _Endoscopia.Diagnostico = ""
        _Endoscopia.CodigoDiagnostico = cboDiagnosticos.EditValue
        _Endoscopia.IdEmpleado = IdEmpleadoG
    ...
    Private Sub frmEndoscopia_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        cboEquipo.Properties.DisplayMember = _ds.Tables(0).Columns(1).Caption
    ...
    Private Sub txtCampo1_EditValueChanged(sender As Object, e As EventArgs) Handles txtCampo1.EditValueChanged
        ActivaGuardar()
    End Sub
    ...
    Private Sub bbiGuardar_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles bbiGuardar.ItemClick
        If chkProcesado.Checked = True Then
            ...
            ElseIf txtCampo1.Text = "" Then
                MessageBox.Show("El campo Reporte de Estudio es obligatorio", "Estudios Endoscopia", MessageBoxButtons.OK, MessageBoxIcon.Information)
            ...
            ElseIf cboDiagnosticos.Text = "" Then
                MessageBox.Show("Diagnostico CIE10 es obligatorio", "Estudios Endoscopia", MessageBoxButtons.OK, MessageBoxIcon.Information)
            Else
