...
Public Class frmDetalleOrden
    ...
    Dim _frmListadoOrdenes As New SIM_ENDOSCOPIA.frmListadoOrdenes
    Public Sub ActualizarOrden()
        MsgBox("Actualizar Orden Detalle Orden")
        _dOrdenes.ActualizarCamposOrdenes(deFechaOrden.Text, txtNumeroOrden.Text, txtAutorizacion.Text, cboSubentidad.GetColumnValue("ID"), txtOrden.Text, "")
    End Sub
