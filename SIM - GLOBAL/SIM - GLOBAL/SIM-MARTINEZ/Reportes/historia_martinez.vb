...
Public Class historia_martinez
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIM_MARTINEZ.historia_martinez.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedhistoria_martinez
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As historia_martinez = New historia_martinez()
        rpt.Site = Me.Site
        Return rpt
    End Function
